<?php
$title = 'Create Booking - Inshaf Hotel';
                ...
                <form method="POST" id="bookingForm">
                            ...
                            <select class="form-select" id="guest_id" name="guest_id" required>
                                ...
                                <?php foreach ($guests as $guest): ?>
                                    <option value="<?php echo $guest['guest_id']; ?>" 
                                            <?php echo ($_POST['guest_id'] ?? '') == $guest['guest_id'] ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="special_requests" name="special_requests" rows="3" 
                                  placeholder="Any special requests or notes for this booking"><?php echo $_POST['special_requests'] ?? ''; ?></textarea>
                    </div>
                    
                    <!-- Total Amount Display -->
                    <div class="alert alert-info" id="totalAmountAlert" style="display: none;">
    ...
    function calculateTotal() {
        ...
        if (checkIn && checkOut && selectedRoom.value) {
            ...
            if (checkOutDate > checkInDate) {
                ...
                totalAmountAlert.style.display = 'block';
            } else {
                totalAmountAlert.style.display = 'none';
            }
        } else {
            totalAmountAlert.style.display = 'none';
        }
