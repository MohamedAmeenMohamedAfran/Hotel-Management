                ...
                <form method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="room_type" name="room_type" required>
                                ...
                                <option value="Executive" <?php echo ($_POST['room_type'] ?? '') === 'Executive' ? 'selected' : ''; ?>>Executive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="max_occupancy" name="max_occupancy" required>
                                ...
                                <option value="1" <?php echo ($_POST['max_occupancy'] ?? '') === '1' ? 'selected' : ''; ?>>1 Guest</option>
                                <option value="2" <?php echo ($_POST['max_occupancy'] ?? '') === '2' ? 'selected' : ''; ?>>2 Guests</option>
                                <option value="3" <?php echo ($_POST['max_occupancy'] ?? '') === '3' ? 'selected' : ''; ?>>3 Guests</option>
                                <option value="4" <?php echo ($_POST['max_occupancy'] ?? '') === '4' ? 'selected' : ''; ?>>4 Guests</option>
                                <option value="6" <?php echo ($_POST['max_occupancy'] ?? '') === '6' ? 'selected' : ''; ?>>6+ Guests</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="amenities" name="amenities" rows="4" 
                                  placeholder="Enter amenities separated by commas (e.g., WiFi, TV, AC, Bathroom, Mini Bar)"><?php echo $_POST['amenities'] ?? ''; ?></textarea>
